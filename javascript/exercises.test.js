...
describe("The meaningfulLineCount function", () => {
  it("throws if no such file", async () => {
    await rejects(async () => await meaningfulLineCount("NoSuchFile.txt"), /Error/)
  })
...
describe("The Quaternion class", () => {
  ...
  it("freezes instances", () => {
    ...
    throws(() => (q.r = 0), /Cannot assign to read only property 'r'/);
    throws(() => (q.i = 0), /TypeError/);
    throws(() => (q.j = 0), /TypeError/);
    throws(() => (q.k = 0), /TypeError/);
  })
